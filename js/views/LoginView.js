                ...
                <div class="max-w-md w-full space-y-8 glass p-10 rounded-2xl shadow-xl">
                    <div>
                        ...
                        <p class="mt-2 text-center text-sm text-gray-600">
                            Or
                            <a href="/register" class="font-medium text-indigo-600 hover:text-indigo-500 transition" data-link>
                    ...
                    <form class="mt-8 space-y-6" id="loginForm">
                        <div class="rounded-md shadow-sm -space-y-px">
                            ...
                            <div>
                                ...
                                <input id="password" name="password" type="password" autocomplete="current-password" required class="appearance-none rounded-none rounded-b-md relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Password" value="password123">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="/forgot-password" class="font-medium text-indigo-600 hover:text-indigo-500" data-link>
                        ...
                        <div>
                            <button type="submit" id="submitBtn" class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition shadow-lg shadow-indigo-600/30">
                                <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <ion-icon name="lock-closed-outline" class="text-indigo-500 group-hover:text-indigo-400 text-lg transition"></ion-icon>
                                </span>
                                Sign in
                            </button>
                        </div>
